...
public interface GoalRepository extends JpaRepository<GoalEntity, Long> {
    ...
    @Query("select new com.example.demo.src.goal.model.GetGoalRes(m.id, m.image, m.goal_amount, m.amount, m.progress) from GoalEntity m")
    List<GetGoalRes> findGoalList(@Param("userEntity") UserEntity userEntity);
